...
{
    [Key] [MaxLength(32)] public string MaterialNumber { get; set; }
    ...
    [MaxLength(32)] public string UntappdId { get; set; }

    public UntappdFetchStatus UntappdFetchStatus { get; set; }

    public bool OnNewProductList { get; set; }

    [MaxLength(64)] public string VinmonopoletStatus { get; set; }
