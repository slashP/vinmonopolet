...
const SearchFilter: React.FC<Props> = () => {
    ...
    const search = () => { rawDataContext.getData()}
    ...
    return (
        <div className={styles.wrapper}>
            <input
                ...
                type="text"
                onChange={(e) => rawDataContext.setQuery(e.target.value)}
                onKeyPress={(e) => {(e.key === 'Enter') && search()}}
                value={rawDataContext.state.query}
