...
const OnlyTBACheckbox = ( props ) => {
    return (
        <div style={styles.bookmarkOnlyCheckbox} className="onlynew-container" title="Show only beer to be announced." onClick={() => props.setShowTBA()}>
            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="-50 -50 370 370" enableBackground="new 0 0 300 300" space="preserve">
                <text  x="0" y="120" fontSize="100" fill="#999">ToBe</text>
                <text x="-20" y="230" fontSize="100" fill="#999">Anno</text>
                { props.showTBA &&
                    <g>
...
export default OnlyTBACheckbox;