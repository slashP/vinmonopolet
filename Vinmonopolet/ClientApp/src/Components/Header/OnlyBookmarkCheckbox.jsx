...
const OnlyBookmarkCheckbox = ( props ) => {
    return (
        <div style={styles.bookmarkOnlyCheckbox} className="onlynew-container" title="Show only beer you have bookmarked." onClick={() => props.setOnlyBookmarks()}>
...
export default OnlyBookmarkCheckbox;