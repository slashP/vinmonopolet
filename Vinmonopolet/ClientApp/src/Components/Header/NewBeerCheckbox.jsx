...
const NewBeerCheckbox = ( props ) => {
    return (
        <div style={styles.newCheckbox} className="onlynew-container" onClick={() => props.onOnlyNew()}>
            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="-50 -50 370 370" enable-background="new 0 0 300 300" space="preserve">     
                <text  x="15" y="120" fontWeight="bold" fontSize="100" fill="#999">Only</text>    
                <text x="23" y="230" fontWeight="bold" fontSize="100" fill="#999">new</text>
                { props.onlyNew && 
                    <g>
